...
namespace TrafficRoad
{
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            int rnd3 = random.Next(100);
            if (rnd3 == 1)
            {
                spawnPedestrian();
            }
            int rnd4 = random.Next(150);
            if (rnd4 == 1)
            {
                spawnBus();
            }
